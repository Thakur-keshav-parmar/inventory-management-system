...
# Find insertion point - just before the Outputs section
...
new_content = content[:outputs_idx] + new_resources + content[outputs_idx:]
...
print(f"ApiDeploymentV2 referenced: {'ApiDeploymentV2' in new_content}")
print(f"ProductsTable present: {'ProductsTable' in new_content}")
print(f"UsersTable present: {'UsersTable' in new_content}")
print(f"BillsTable present: {'BillsTable' in new_content}")
print(f"SettingsTable present: {'SettingsTable' in new_content}")
